...
class PlayedSongDocument: MeteorDocument, MeteorSong {
    var collection:String = "playedSongs"
    var _id: String = ""
    ...
    var platform: String = ""
    var score: Int = 0
    var playedAt: NSDate = NSDate(timeIntervalSinceNow: 0)
